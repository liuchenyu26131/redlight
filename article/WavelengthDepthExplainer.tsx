    ...
    <>
      ...
      {open ? (
        <div className="iluxred-depth-modal" role="dialog" aria-modal="true" aria-label="不同波长红光穿透深度" onClick={() => setOpen(false)}>
          <div className="iluxred-depth-modal__panel" onClick={(event) => event.stopPropagation()}>
            ...
            <h2>不同波长红光穿透深度</h2>
            <img src={wavelengthDepthImage} alt="不同波长红光穿透深度示意图" loading="lazy" decoding="async" />
            <ul>
